...
#>  * <chr>       <chr>                   <int>         <int>     <int>
#>  1 Q4800324-11 Q4800324-12                 1             4        -1
#>  2 Q3568543-10 Q3568543-13                 4             4        -1
#>  3 Q99637288-1 Q99637288-10                4             4         5
#>  4 Q5931349-11 Q5931349-12                 3             4        -1
#>  5 Q5392750-10 Q5392750-14                 1             4        -1
#>  6 Q5392750-12 Q5392750-14                 1             4        -1
#>  7 Q3431381-1  Q3431381-8                  4             4         5
#>  8 Q3431381-4  Q3431381-8                  4             4         5
#>  9 Q3431381-5  Q3431381-8                  4             3         5
#> 10 Q99806336-1 Q99806336-3                 4             4        -1
#> # ℹ 220,791 more rows
...
#>    <chr>        <chr>               
#>  1 Q2389414-2   cluster_Q2389414-1  
#>  2 Q2389414-10  cluster_Q2389414-1  
#>  3 Q2423083-1   cluster_Q2423083-1  
#>  4 Q19870549-4  cluster_Q19870549-1 
#>  5 Q104787626-2 cluster_Q104787626-1
#>  6 Q6779642-11  cluster_Q6779642-1  
#>  7 Q9267214-1   cluster_Q9267214-1  
#>  8 Q1104906-5   cluster_Q1104906-1  
#>  9 Q1104906-6   cluster_Q1104906-1  
#> 10 Q1104906-11  cluster_Q1104906-1  
#> # ℹ 46,141 more rows
```
...
#>  1 Q15176618-3 Q8005070-4           23.4             1.000 FALSE      false_pos…
#>  2 Q15176618-6 Q8005070-3           22.4             1.000 FALSE      false_pos…
#>  3 Q15176618-8 Q8005070-3           22.8             1.000 FALSE      false_pos…
#>  4 Q17627000-1 Q24845632-12         23.6             1.000 FALSE      false_pos…
#>  5 Q17627000-1 Q24845632-11         24.1             1.000 FALSE      false_pos…
#>  6 Q18875129-2 Q6525430-8           25.0             1.000 FALSE      false_pos…
#>  7 Q5583974-4  Q6130041-3           23.7             1.000 FALSE      false_pos…
#>  8 Q5583974-1  Q6130041-2           23.7             1.000 FALSE      false_pos…
#>  9 Q5583974-3  Q6130041-2           23.7             1.000 FALSE      false_pos…
#> 10 Q5583974-5  Q6130041-2           23.7             1.000 FALSE      false_pos…
#> # ℹ 118 more rows
```
...
#>    unique_id_l  unique_id_r match_weight match_probability true_label error_type
#>    <chr>        <chr>              <dbl>             <dbl> <lgl>      <chr>     
#>  1 Q5722458-5   Q5722458-6          9.53            0.211  TRUE       false_neg…
#>  2 Q7360161-19  Q7360161-5          9.95            0.264  TRUE       false_neg…
#>  3 Q6221353-13  Q6221353-2          9.85            0.252  TRUE       false_neg…
#>  4 Q4786206-13  Q4786206-9          9.68            0.229  TRUE       false_neg…
#>  5 Q4307608-13  Q4307608-8          8.55            0.120  TRUE       false_neg…
#>  6 Q13128330-8  Q13128330-9         7.29            0.0538 TRUE       false_neg…
#>  7 Q7333359-16  Q7333359-8          9.07            0.163  TRUE       false_neg…
#>  8 Q25207083-12 Q25207083-7        10.7             0.372  TRUE       false_neg…
#>  9 Q25207083-13 Q25207083-7        10.7             0.372  TRUE       false_neg…
#> 10 Q4786206-13  Q4786206-8          9.68            0.229  TRUE       false_neg…
#> # ℹ 112,552 more rows
```
