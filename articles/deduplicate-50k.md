...
#>  * <chr>        <chr>                   <int>         <int>     <int>
#>  1 Q4800324-10  Q4800324-12                 1             4        -1
#>  2 Q3568543-10  Q3568543-13                 4             4        -1
#>  3 Q5931349-11  Q5931349-12                 3             4        -1
#>  4 Q5392750-10  Q5392750-14                 1             4        -1
#>  5 Q3431381-3   Q3431381-8                  4             4         5
#>  6 Q3431381-4   Q3431381-8                  4             4         5
#>  7 Q3431381-6   Q3431381-8                  4             4         5
#>  8 Q99806336-1  Q99806336-3                 4             4        -1
#>  9 Q99806336-2  Q99806336-3                 4             4        -1
#> 10 Q18814497-11 Q18814497-16                4             4        -1
#> # ℹ 244,220 more rows
...
#>    <chr>        <chr>              
#>  1 Q19356933-3  cluster_Q19356933-1
#>  2 Q19356933-4  cluster_Q19356933-1
#>  3 Q4710334-1   cluster_Q4710334-1 
#>  4 Q4710334-3   cluster_Q4710334-1 
#>  5 Q43260413-11 cluster_Q43260413-1
#>  6 Q15997648-2  cluster_Q15997648-1
#>  7 Q16205314-2  cluster_Q16205314-1
#>  8 Q24845727-2  cluster_Q24845727-1
#>  9 Q4204296-12  cluster_Q4204296-1 
#> 10 Q1065952-11  cluster_Q1065952-1 
#> # ℹ 46,210 more rows
```
...
#>  1 Q17627000-1 Q24845632-11         24.7             1.000 FALSE      false_pos…
#>  2 Q3568485-1  Q3568487-2           40.7             1.000 FALSE      false_pos…
#>  3 Q3568485-3  Q3568487-2           35.7             1.000 FALSE      false_pos…
#>  4 Q3568485-6  Q3568487-2           35.2             1.000 FALSE      false_pos…
#>  5 Q3568485-7  Q3568487-2           26.9             1.000 FALSE      false_pos…
#>  6 Q1512-10    Q325068-1            24.8             1.000 FALSE      false_pos…
#>  7 Q48818396-3 Q48818466-2          25.4             1.000 FALSE      false_pos…
#>  8 Q3568485-11 Q3568487-2           24.5             1.000 FALSE      false_pos…
#>  9 Q3568485-11 Q3568487-1           24.5             1.000 FALSE      false_pos…
#> 10 Q1156193-12 Q19008-13            21.7             0.999 FALSE      false_pos…
#> # ℹ 423 more rows
```
...
#>    unique_id_l  unique_id_r match_weight match_probability true_label error_type
#>    <chr>        <chr>              <dbl>             <dbl> <lgl>      <chr>     
#>  1 Q16199241-13 Q16199241-7         9.78            0.218  TRUE       false_neg…
#>  2 Q16030123-16 Q16030123-…        10.3             0.284  TRUE       false_neg…
#>  3 Q28924147-13 Q28924147-…         9.16            0.153  TRUE       false_neg…
#>  4 Q28924147-14 Q28924147-…         8.28            0.0893 TRUE       false_neg…
#>  5 Q15994531-10 Q15994531-7        10.0             0.250  TRUE       false_neg…
#>  6 Q33142884-10 Q33142884-…         6.60            0.0297 TRUE       false_neg…
#>  7 Q33142884-12 Q33142884-…         9.78            0.218  TRUE       false_neg…
#>  8 Q942725-1    Q942725-13         10.8             0.353  TRUE       false_neg…
#>  9 Q6285569-10  Q6285569-13        10.0             0.250  TRUE       false_neg…
#> 10 Q5725468-10  Q5725468-17        10.0             0.250  TRUE       false_neg…
#> # ℹ 68,401 more rows
```
