...
pairs_lazy
#> <il_compared_lazy> 2,946 pairs in table __il_8644_1_predicted_4 (threshold = 0.5)
```
...
#>   <chr>     <chr>        <int>           <dbl>
#> 1 664       cluster_133      5          0.116 
#> 2 972       cluster_133      4          0.0930
#> 3 364       cluster_133      6          0.140 
#> 4 670       cluster_133     12          0.279 
#> 5 790       cluster_133      4          0.0930
#> 6 855       cluster_133      7          0.163
```
