...
pairs_lazy
#> <il_compared_lazy> 2,946 pairs in table __il_8650_1_predicted_4 (threshold = 0.5)
```
...
#> 10 cluster_105       9      23   0.639                  0.304
#> # ℹ 106 more rows
```
...
#> 3 458       cluster_164     10          0.323 
#> 4 167       cluster_164      7          0.226 
#> 5 48        cluster_164      4          0.129 
