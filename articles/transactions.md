...
#>  1          14       44143         10.0             0.794 FALSE      false_posi…
#>  2          21       42616         11.5             0.915 FALSE      false_posi…
#>  3         128       41922         11.2             0.896 FALSE      false_posi…
#>  4         213       44457         14.3             0.987 FALSE      false_posi…
#>  5         549       33002         10.8             0.867 FALSE      false_posi…
#>  6         861       44153         11.2             0.896 FALSE      false_posi…
#>  7         946       40570         17.6             0.999 FALSE      false_posi…
#>  8        1100       38419         14.3             0.987 FALSE      false_posi…
#>  9        1120       42614         11.5             0.915 FALSE      false_posi…
#> 10        1291       32172         11.2             0.896 FALSE      false_posi…
#> # ℹ 43,960 more rows
```
...
#>    unique_id_l unique_id_r match_weight match_probability true_label error_type 
#>          <dbl>       <dbl>        <dbl>             <dbl> <lgl>      <chr>      
#>  1        1723        1723         5.54            0.148  TRUE       false_nega…
#>  2         510         510         6.70            0.280  TRUE       false_nega…
#>  3         618         618         7.72            0.440  TRUE       false_nega…
#>  4         655         655         7.01            0.326  TRUE       false_nega…
#>  5       36867       36867         2.93            0.0277 TRUE       false_nega…
#>  6       37738       37738         7.90            0.472  TRUE       false_nega…
#>  7       37829       37829         7.40            0.387  TRUE       false_nega…
#>  8       38238       38238         6.70            0.280  TRUE       false_nega…
#>  9       38371       38371         7.90            0.472  TRUE       false_nega…
#> 10       38801       38801         7.72            0.440  TRUE       false_nega…
#> # ℹ 5,416 more rows
```
