...
#>  7       10620       37608        11.2              0.896 FALSE      false_posi…
#>  8       11071       28175        11.5              0.915 FALSE      false_posi…
#>  9       11105        5419        11.2              0.896 FALSE      false_posi…
#> 10       11252       40346        16.4              0.997 FALSE      false_posi…
#> # ℹ 43,960 more rows
```
...
#>    unique_id_l unique_id_r match_weight match_probability true_label error_type 
#>          <dbl>       <dbl>        <dbl>             <dbl> <lgl>      <chr>      
#>  1       18067       18067         3.91            0.0533 TRUE       false_nega…
#>  2       33565       33565         3.91            0.0533 TRUE       false_nega…
#>  3       43391       43391         4.48            0.0767 TRUE       false_nega…
#>  4       44423       44423         1.62            0.0113 TRUE       false_nega…
#>  5        2014        2014         7.40            0.387  TRUE       false_nega…
#>  6         907         907         6.70            0.280  TRUE       false_nega…
#>  7        1118        1118         7.72            0.440  TRUE       false_nega…
#>  8         898         898         5.54            0.148  TRUE       false_nega…
#>  9         660         660         2.93            0.0277 TRUE       false_nega…
#> 10         784         784         7.01            0.326  TRUE       false_nega…
#> # ℹ 5,416 more rows
```
