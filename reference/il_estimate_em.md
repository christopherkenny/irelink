...
be chained to train on complementary subsets of record pairs — each call
updates the model cumulatively.

## Usage

``` r
il_estimate_em(model, blocking, ...)
```
...
- ...:
  ...
  Reserved for future options (e.g., convergence tolerance, maximum
  iterations).
