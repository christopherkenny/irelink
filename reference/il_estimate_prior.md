...
This prior anchors the Fellegi-Sunter model. Analogous to fitting a base
rate before more detailed parameter estimation.
...
- ...:
  ...
  that define deterministic matching criteria.
