...
Splink's prediction `match_weight` includes the prior odds. In `irelink`,
`match_weight` is evidence-only and `total_match_weight` is the prior-inclusive
log2 odds. Probability thresholds are portable; match-weight thresholds need
that prior adjustment.
