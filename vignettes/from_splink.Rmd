...
The difference is where the rules are used.
Splink passes them into `SettingsCreator`.
`irelink` adds them to a spec with `il_block_on()` or passes them directly to training functions.
