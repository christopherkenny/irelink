...
This vignette replicates the
[Splink "Linking banking transactions" demo](https://moj-analytical-services.github.io/splink/demos/examples/duckdb/transactions.html)
using `irelink`.
...
```{r setup-con}
con <- DBI::dbConnect(duckdb::duckdb(tempdir = tempdir()))
```
